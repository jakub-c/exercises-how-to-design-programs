...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname |268|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define (sort-inv l)
  (local (; Inventory -> Number
          ...
          ; compare aqusition price to sales price
          (define (aq>sl i1 i2) (> (diff-price i1)
                                   (diff-price i2))))
    (sort l aq>sl)))
