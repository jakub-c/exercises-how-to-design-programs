...
(check-expect (interpreter-expr '(+ 1 (* 3 4))) 13)
(check-error (interpreter-expr '("a")) WRONG) 

; accept S-expressions, if parse recognizes them as BSL-expr, produce their value.
; Otherwise, signal the same error as pars

; S-expr -> Number
; (define (interpreter-expr s) 1) ;stub
