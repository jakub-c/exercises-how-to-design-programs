...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname 12.3.217) (read-case-sensitive #t) (teachpacks ((lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
(require 2htdp/image)
...
(main (make-ws "plat" (make-worm (list (make-posn 2 1) (make-posn 2 2) (make-posn 2 3)) "")))